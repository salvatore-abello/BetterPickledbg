...
print(pickletools.dis(open("examples/unipickle", "rb")))

pa = PickleAssembler(proto=4)
pa.push_binunicode("os")
pa.push_binunicode("system")
pa.memo_binput(194)
pa.push_empty_set()
pa.pop()
pa.pop()
